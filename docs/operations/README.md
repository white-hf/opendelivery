...
本目录是 Operations Web 与 Operations API 团队的唯一当前入口。运营产品负责订单准备、区域与运力规划、到仓、扫描监督、交接审批、派送/回仓监督、异常和日终，不代替司机执行扫描或派送。

## 当前文档

| 类型 | 当前文档 |
|---|---|
| 产品模型 | [运营系统产品模型](../prd/operations-system-product-model.md) |
| UI 产品规格 | [运营 Web 规格](../prd/operations-web-specification.md)、[控制塔](../prd/operations-control-tower.md) |
