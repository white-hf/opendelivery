...
Results: 27 Java tests and 13 Operations Web tests passed; Maven clean verify and Web test/typecheck/lint/build succeeded. The real schema reached V9. R01.1 verified French auth output, Chinese account-default output, English fallback, bundle key equality, and real-MySQL operator preference persistence; the test preference was restored. R01 spatial evidence remains green.
