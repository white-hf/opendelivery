export const PAGE_KEYS = ['dashboard','orders','dispatch','dispatch-reassign','manifests','scanning','handover','delivery','closeout','cases','areas','drivers','stations','callbacks'] as const;
...
const ROLE_PAGES: Record<string, readonly PageKey[]> = {
    ...
    DISPATCHER: ['dashboard','orders','dispatch','dispatch-reassign','delivery','closeout','cases','areas','drivers'],
};
